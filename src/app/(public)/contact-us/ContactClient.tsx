            ...
            <div className="sticky top-24 space-y-6">
                ...
                <div className="bg-white p-6 shadow-xl shadow-gray-200/50 rounded-3xl border border-gray-100">
                    ...
                    <div className="space-y-1">
                        <ContactRow title="General Inquiries" email="info@gifon.org.ng" />
                        <div className="h-px bg-gray-100 my-2"></div>
                        
                        <ContactRow title="Secretariat" phone="+234 707 721 1243" email="secretariat@gifon.org.ng" />
                         <div className="h-px bg-gray-100 my-2"></div>

                        <ContactRow title="Outreach" phone="+234 707 726 9829" email="outreach@gifon.org.ng" />
                         <div className="h-px bg-gray-100 my-2"></div>

                        <ContactRow title="Membership" phone="+234 707 721 1243" email="membership@gifon.org.ng" />
                        <div className="h-px bg-gray-100 my-2"></div>

                        <ContactRow title="Education" phone="+234 707 721 1243" email="Education@gifon.org.ng" />
                        <div className="h-px bg-gray-100 my-2"></div>
                        
                        <ContactRow title="Events & Exhibitions" phone="+234 707 739 6196" email="Events.exhibition@gifon.org.ng" />
                    </div>
                </div>
            </div>
