      ...
      <section className="bg-gray-100 py-16 px-4">
        <div className="max-w-5xl mx-auto space-y-10">
          <div className="text-center">
            <h2 className="text-3xl font-semibold mb-4">A MESSAGE FROM THE FOUNDER/CHAIRMAN GEOSPATIAL INTELLIGENCE FOUNDATION OF NIGERIA</h2>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-700 leading-relaxed">
              To be Nigeria’s leading catalyst for geospatial innovation, empowering national development
              through actionable intelligence, spatial data excellence, and sustainable technological
              advancement.
            </p>
          </div>
