// app/(public)/Eyes-on-Location/PublicationsClient.tsx
        ...
        <section id="about" className="py-20 px-4 bg-white">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="text-gray-600 leading-relaxed text-lg space-y-4 text-justify mx-auto">
              <p>The GeoINSIGHT Bulletin is <span className="cooper font-bold text-gray-800">GIFON</span>&apos;s official monthly newsletter, designed to provide timely updates, insights, and highlights from the world of geospatial intelligence (GEOINT), innovation, and national development initiatives. It offers readers a curated digest of programme updates, capacity building activities, research breakthroughs, community projects, events, and policy developments. The Bulletin aims to connect, inform, and inspire <span className="cooper font-bold text-gray-800">GIFON</span>&apos;s growing community of professionals, students, innovators, and stakeholders, keeping them engaged with the latest trends, opportunities, and achievements in geospatial intelligence across Nigeria and beyond.</p>
            </div>
          </div>
        </section>
