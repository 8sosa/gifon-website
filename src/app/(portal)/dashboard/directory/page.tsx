...
import { 
  ...
  GraduationCap,
  CheckCircle2,
  ArrowLeft // Ensure ArrowLeft is imported
} from 'lucide-react';
...
// Combine both types of modal state
...
export default function DirectoryForumsPage() {
  ...
  return (
    <>
      ...
      {/* 1. Policy Modal (Existing Component) */}
      ...
      {/* 2. Join Request Success Modal (Inline Implementation for speed) */}
