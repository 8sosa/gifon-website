...
import { UserPlus, X } from 'lucide-react'; // Added 'X' icon
  ...
  return (
    <>
                      ...
                      <div key={`lvl2-${i}`} className="flex flex-col items-center relative">
                          {m ? (
                              ...
                              <div 
                                ...
                                className="flex flex-col items-center text-center w-full max-w-[140px] group cursor-pointer"
                              >
      ...
      {selectedMember && (
        ...
        >
          <div 
            className="bg-white rounded-2xl w-full max-w-3xl overflow-hidden shadow-2xl relative animate-in fade-in zoom-in duration-300"
          ...
          >
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="w-full md:w-3/5 p-8 md:p-10 flex flex-col justify-center">
                <div className="mb-6">
                  <h3 className="text-3xl font-bold text-gray-900 bellefair mb-2">
                    {selectedMember.name}
                  </h3>
                  <div className="inline-block bg-green-50 px-3 py-1 rounded-full border border-green-100">
                    <p className="text-green-700 font-semibold text-sm sen uppercase tracking-wide">
                      {selectedMember.role}
                    </p>
                  </div>
                </div>
