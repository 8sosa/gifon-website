        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-top">
          ...
          >
            <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6">
              <strong className="text-green-800">Dr. AA Usman</strong> is the Founder and Executive Chairman of the Geospatial Intelligence Foundation of Nigeria (<span className="cooper text-green-700">GIFON</span>) and the Founder and Group Chief Executive of RESLARC Group, a pioneering Nigerian institution established to advance intelligence grade geospatial analytics, research, and applied spatial solutions.
              <br/>
          ...
          >
            <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6">
              ...
              <br/>
              His work bridges enterprise and public interest, building indigenous capability through RESLARC while shaping national discourse, coordination, and international engagement through <span className="cooper text-green-700">GIFON</span>.
              <br/>
            ...
            <a 
              href="#"
              className="group inline-flex items-center gap-2 text-green-700 font-bold hover:text-green-900 transition-all border-b-2 border-green-200 hover:border-green-600 pb-1"
            >
              Read Full Biography
