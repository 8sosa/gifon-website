...
const topBarItemsBase = [
  {
    ...
    href: '/resources',
    children: [
      { label: 'Geospatial Tools & Portals', anchor: 'tools' },
      { label: 'Datasets & Maps', anchor: 'datasets' },
      { label: 'Training Materials', anchor: 'materials' },
  ...
  },
  {
    ...
    href: '/donate',
    children: [
      { label: 'Ways to Support GIFON', anchor: 'ways' },
      { label: 'Donate Online', anchor: 'donate-online' },
      { label: 'Volunteer', anchor: 'volunteer' },
      { label: 'CSR Opportunities', anchor: 'csr' },
    ],
  },
  {
    label: 'Login',
